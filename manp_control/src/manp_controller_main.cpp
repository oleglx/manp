...
class Manipulator {
	...
	public:
		...
		void getAngles( std::vector<float>& manp_angles);
...
int main( int argc, char **argv ) {
	std::vector<float> control(3), start_angles(3), test_angles(3);
...
void Manipulator::getAngles( std::vector<float>& manp_angles ) {
	manp_angles = angles;
}
